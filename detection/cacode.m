...
% source: http://www.mathworks.com/matlabcentral/mlc-downloads/downloads/submissions/14670/versions/2/previews/cacode.m/index.html
%
% Changes: Transform from 1 and 0 to 1 and -1 (last line).
...
% rev 1.4 Dan Boschen 6-1-2010   Updated email address in comments
    ...
    % Change: transform from 1 and 0 to 1 and -1
    g = 2*g-1;
end